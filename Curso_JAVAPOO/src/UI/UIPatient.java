...
public class UIPatient {
    ...
    private static void showBookAppointmentMenu(){
        ...
        do {
            ...
            int k = 0;
            for (int i = 0; i < UIDoctor.doctorsAvailableAppointments.size(); i++) {
                ArrayList<Doctor.AvailableAppointment> availableAppointments
                        = UIDoctor.doctorsAvailableAppointments.get(i).getAvailableAppointments();
                ...
                for (int j = 0; j < availableAppointments.size(); j++) {
                    ...
                    doctorAppointments.put(Integer.valueOf(j), UIDoctor.doctorsAvailableAppointments.get(i));
